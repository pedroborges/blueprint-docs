    ...
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <div class="flex my-10">
                ...
                <a href="https://www.youtube.com/watch?v=Jna0DOgnxds" title="Ship faster with Blueprint talk on Laracon AU 2025" class="bg-gray-300 hover:bg-gray-500 text-blue-900 font-normal hover:text-white rounded py-2 px-6" rel="external">Watch an Overview</a>
            </div>
        </div>
